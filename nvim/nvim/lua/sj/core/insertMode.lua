...
--[[ function RunNodemonInTmuxPane()
	...
	-- First, stop any running process in the third pane by sending Ctrl+C
	local stop_command = "tmux send-keys -t 2 C-c"
	...
	local start_command = 'tmux send-keys -t 2 "nodemon ' .. file_path .. '" C-m'
	vim.fn.system(start_command)

	-- Optional: Notify the user
	vim.notify("Restarted nodemon in pane 2 for file: " .. file_path)
end ]]
